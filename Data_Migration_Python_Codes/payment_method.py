...
def get_items_and_write_to_file():
    ...
    refresh_token = 'AB11689506431gdtZAql2Renen81LoTtkeGQsT9s5WX6KPXmJ7'
    access_token = 'eyJlbmMiOiJBMTI4Q0JDLUhTMjU2IiwiYWxnIjoiZGlyIn0..4u6bCo1hK4z2tkKIhSJw_w.RkFyA3DiM3bfsKWsEpeOEnONXuj-4oqHH1UaMJFY7ISTAxJ_YWRM64xxYZrCvHq98apdUuQ_aJDXOptZVo51KXWFmCQOOlgzGNixZWxMHVnOLIoy1mfIIe8dtzMjEBncQ3g561kJfp-GLyg2tx4XYlfT5LYr89sphKJYyH3GebWdrCrF4jGpStmGP5RWD_gjoOmeFQgGoaz2QChNgAdxgsEVRPy0qR5Wimcay3JOPKpjPZJ2hIMQdnE9-_jEbdmmTum6HUhqC1ia5GIxn4PHoSTsHCYaDR07Lck2Xte-yqz6J8PPmt122wgWLplJCic0R61V5iUOgPuiWHozh8vW17KCpKV7kwXaQJ8AiS2De0kSSDbA_ocOJX_h9dtSxX_cTcyvvONXX52jpEJKlwzJTABKsTGtEuDCCQslOH98G56vlTj9YexBy3CCxdA015s0V1_73K1bfRmmCkY3FF1rmxMX2UkMLSGNkTp1OkQGewyoUHqoIgHQZb522PST53kvV7H9oHFHUQLqv22OtsbPxhLqCmUcKJ5pvwT85wEGJE1ZHRWOAqwtdC-iBnHcW7rvYq6OHxou-xPBR2g4dQP4e8YCFncHMeaX8Vi71kifAbLpZYFMI3g6rm6YpltsSh3-YumdOMBTHoIhkG2tgXKOmGnRWJ5aRGd0MChulZeMvjxLdAzmUCoHIQgac79VKJkcmIJLIo4laQpyVQqSE0WDqLHC0M1JhlX50e10scoER8E.1ppoFN3Lek7lKNIC8nJdwg'
    ...
    file_name = 'data_from_qb_inactive_PR.json'
    # file_name = 'data_from_qb_inactive_flynow.json'
    ...
    flag = True
    while flag == True:
        selectQuery = f'select * from PaymentMethod where Active=False startPosition {startPosition}'
        ...
        #         if "PaymentMethod" in parsed_data["QueryResponse"]:
        #             for element in parsed_data["QueryResponse"]["PaymentMethod"]:
...
def generate_post_json():
    ...
    file_name = 'data_from_qb_inactive.json'
