...
def mapping_func():
    ...
    qb_vndr=json.load(open("qb_vndr.json"))
...
def post_request_zoho():
    ...
    response_save_file = open("saved_contact_id_vndr_pr.txt","a")
    ...
    for item in items_list:
        while True:
            ...
            if parsed_data3["code"] == 57:
                ...
                response_save_file.write(f'{parsed_data3["contact_id"]} : {item["email"]}\n')
