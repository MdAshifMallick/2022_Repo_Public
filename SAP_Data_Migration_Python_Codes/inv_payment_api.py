...
def post_request_zoho_payment():
    ...
    post_url = f'https://books.zoho.in/api/v3/customerpayments?ignore_auto_number_generation=true&organization_id={organization_id}'

    # f = open('mapped.json')
    # f = open('failed_mapped.json')
    # f = open('to_again_mapped.json')
    # f = open('payment_mapped.json')
    f = open('mapped_ip_2019_D_C_note.json')
    ...
    response_save_file = open("saved_payment_2019_Payment.txt","a")
