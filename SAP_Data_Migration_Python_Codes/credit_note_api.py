...
def post_request_zoho():
    ...
    response_save_file = open("saved_credit_D_Debit_Credit Note.txt","a")
    ...
    organization_id = '60023777137'
    post_url = f'https://books.zoho.in/api/v3/creditnotes?ignore_auto_number_generation=true&organization_id={organization_id}'
    ...
    f = open('mapped_credit_2018_D_Debit_Credit Note.json')
    ...
    for item in items_list:
        ...
        while True:
            print(f'Processing for crdit_number: {item["id_from_qb"]}||{item["date"]}||{item["customer_id"]}....')
            ...
            if parsed_data3["code"] == 57:
                ...
                with open('creditnote_data.json', 'w',buffering=1024*1024) as f:
