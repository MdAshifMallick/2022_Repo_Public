...
def post_request_zoho():
    ...
    post_url = f'https://books.zoho.in/api/v3/bills?ignore_auto_number_generation=true&organization_id={organization_id}'

    # f = open('mapped.json')
    # f = open('failed_mapped.json')
    # f = open('to_again_mapped.json')
    f = open('mapped_bills_2019_Inv_Bill.json')
    ...
    response_save_file = open("saved_bill_id__2019_Inv_Bill.txt","a")
